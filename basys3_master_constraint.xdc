...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports BUTTONS[3]]						
...
##VGA Connector
    set_property PACKAGE_PIN G19 [get_ports {VGA_RGB[7]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_RGB[7]}]
    set_property PACKAGE_PIN H19 [get_ports {VGA_RGB[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_RGB[6]}]
    set_property PACKAGE_PIN J19 [get_ports {VGA_RGB[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_RGB[5]}]
    #set_property PACKAGE_PIN N19 [get_ports {vgaRed[3]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {vgaRed[3]}]
    set_property PACKAGE_PIN N18 [get_ports {VGA_RGB[1]}]				
